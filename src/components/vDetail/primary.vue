...
<script>
import { queryOverviewDetai } from '../../api/overview'
export default {
  components: {},
  ...
  created() {
    ...
    queryOverviewDetai({ id: typeId }).then(res => {
      console.log(res)
      if(res.code === 2000) {
